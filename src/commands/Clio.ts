...
export class Clio {
	...
	/** Command abstraction to unlock a package
	 * - See _clio pull package_ {@link https://github.com/Advance-Technologies-Foundation/clio/blob/master/clio/Command/UnlockPackageCommand.cs **documentation**}
	 */
	public readonly unlockPackage : ICommand<IUnlockPkgArgs, IUnlockPkgResponse> = new UnlockPkg(this.executor);
	
	/** Command abstraction to lock a package
	 * - See _clio pull package_ {@link https://github.com/Advance-Technologies-Foundation/clio/blob/master/clio/Command/LockPackageCommand.cs **documentation**}
	 */
